...
function Home() {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `https://6374eb8a48dfab73a4ece0b6.mockapi.io/items?page=${currentPage}&sortBy=${sortType}&limit=4${category}&order=${directions}${search}`,
            )
            .then((res) => {
                setPizzas(res.data);
                setIsLoading(false);
            });
    }, [categoryId, direction, sortType, searchValue, currentPage]);
    ...
    return (
        <div className="container">
            <div className="content__top">
                ...
                <Sort onChangeDirection={setDirection} direction={direction} />
            </div>
